...
int main(int argc, char *argv[])
{
    ...
    const char  *filenameSrc = "Microsoft LifeCam VX-800";
    ...
    if(avformat_open_input(&pFormatCtx,filenameSrc,iformat,NULL) != 0){ cout<<"12"<<endl;   return -12; }
    //if(avformat_find_stream_info(pFormatCtx) < 0)   return -13;
    ...
    if(videoStream == -1)
    {return -14;    cout<<"14"<<endl;}
    pCodecCtx = pFormatCtx->streams[videoStream]->codec;

    pCodec =avcodec_find_decoder(pCodecCtx->codec_id);
    if(pCodec==NULL)
    {cout<<"15"<<endl;  return -15; /*codec not found*/}

    if(avcodec_open2(pCodecCtx,pCodec,NULL) < 0)
    {cout<<"16"<<endl;  return -16;}
